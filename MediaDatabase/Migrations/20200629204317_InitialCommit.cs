    ...
    public partial class InitialCommit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "xavier.long4@outlook.com", "P@$$w0rd1234!@#$" },
                    { 2, "tsijiang@hotmail.com", "qwer1234QWER!@#$" },
                    { 3, "longx@my.erau.edu", "Pa$$w0rd11!!" },
                    { 4, "tsijiang@gmail.com", "P4$$w0rd" },
                    { 5, "tsijiang@yahoo.com", "wh4tPa$$w0rd" },
                    { 6, "tsijiang@aol.com", "password" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 13, new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Time Life Music Collection", 55.0, "TR", 4 },
                    { 14, new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Greatest Hits: Volume 12", 55.0, "TR", 4 },
                    { 15, new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Now Thats What I Call Music", 55.0, "TR", 4 }
                });
